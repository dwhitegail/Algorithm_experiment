...
class Preview_Advice(Page):
    ...
    def vars_for_template(player: Player):
        ...
        if player.treatment == 'algorithmic':
            ...
            advice_description = (
                "The Algorithmic advice for the weight and height estimation tasks"
                "have been generated by Google Gemini 3.1."
                
                "The Algorithmic advice for the Urns Task have been generated by Claude Sonnet 4.6"
                
                "The Human advice for all tasks is an aggregated average of 40 participants"
                "who completed identical tasks"
            )
        else:
