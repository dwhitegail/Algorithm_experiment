...
class Preview_Advice(Page):
    ...
    def vars_for_template(player: Player):
        ...
        if player.treatment == 'algorithmic':
            ...
            advice_description = (
                "The advice for the weight and height estimation tasks"
                "have been generated by Google Gemini 3.1."
                
                "The advice for the Urns Task have been generated by Claude Sonnet 4.6"
...
class Mpl(Page):
    ...
    @staticmethod
    def is_displayed(player):
        return player.qid and player.treatment != 'none'
...
page_sequence = [Consent, Instructions, Pre_beliefs, Preview_Advice, Mpl, Mpl_results, Advice, Post_beliefs, ThankYou, Reveal, Results]
