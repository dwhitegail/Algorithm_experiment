...
class Payoff(Page):
    ...
    def vars_for_template(player: Player):
        ...
        question_meta = {
            ...
            'song01':   {'title': 'Daisies by Justin Bieber', 'true_value': 'Position 8'},
            'song02':   {'title': 'Ordinary by Alex Warren',  'true_value': 'Position 2'},
            'song03': {'title': 'Not Like Us by Kendrick Lamar', 'true_value': 'Position 8'},
            'song04': {'title': 'Golden by HUNTR/X: EJAE, Audrey Nuna & REI AMI', 'true_value': 'Position 1'},
            'song05': {'title': 'Lose Control by Teddy Swims', 'true_value': 'Position 7'},
            'song06': {'title': 'Just in Case by Morgan Wallen', 'true_value': 'Position 9'},
            'song07': {'title': 'A Bar Song (Tipsy) by Shaboozey', 'true_value': 'Position 10'},
            'song08': {'title': 'What I Want by Morgan Wallen ft. Tate McRae', 'true_value': 'Position 3'},
            'song09': {'title': 'Soda Pop by Saja Boys', 'true_value': 'Position 5'},
            'song10': {'title': 'Luther by Kendrick Lamar', 'true_value': 'Position 10'},
            'song11': {'title': 'Die with a smile by Lady Gaga & Bruno Mars', 'true_value': 'Position 10'},
            'song12': {'title': 'Your Idol by Saja Boys', 'true_value': 'Position 4'},
            'song13': {'title': 'Love Me Not by Ravyn Lenae', 'true_value': 'Position 6'},
            'song14': {'title': 'Birds of a Feather by Billie Ellish ', 'true_value': 'Position 7'},
            'song15': {'title': 'APT by ROSE and Bruno Mars', 'true_value': 'Position 10'},
            'song16': {'title': 'TV OFF by Kendrick Lamar', 'true_value': 'Position 10'},
